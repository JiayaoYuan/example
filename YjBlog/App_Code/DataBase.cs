...
public class DataBase
{
    ...
    {
        SqlDataAdapter dap = CreateDataAdaperText(procName, prams);
        DataSet ds = new DataSet();
        dap.Fill(ds);
        this.Close();
        //得到执行成功返回值
    ...
    /// <param name="prams">参数对象</param>
    /// <returns></returns>
    private SqlDataAdapter CreateDataAdaperText(string procName, SqlParameter[] prams)
    {
        this.Open();
        SqlDataAdapter dap = new SqlDataAdapter(procName, con);
    ...
    private SqlCommand CreateCommand(string procName, SqlParameter[] prams)
    {
        ...
        this.Open();
        SqlCommand cmd = new SqlCommand(procName, con);
        cmd.CommandType = CommandType.StoredProcedure;　　　　 //执行类型：存储过程
    ...
    /// <param name="prams"命令文本所需参数</param>
    /// <returns>返回SqlCommand对象</returns>
    private SqlCommand CreateCommandText(string procName, SqlParameter[] prams)
    {
        // 确认打开连接
        this.Open();
        SqlCommand cmd = new SqlCommand(procName, con);
